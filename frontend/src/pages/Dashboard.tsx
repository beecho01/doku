...
export default function Dashboard() {
  ...
  // Dashboard data polling configuration
  ...
  // System data polling configuration
  ...
  // Ping data polling configuration
  ...
  // Event data polling configuration
  ...
  return (
    <div className="space-y-4 font-sans">
      ...
      {/* Main Grid */}
      <h2 className="text-lg font-semibold pl-1 pt-2">Usage distribution</h2>
      ...
      {/* Summary Cards */}
      <h2 className="text-lg font-semibold pl-1 pt-4">Summary</h2>
      <SummaryCards data={data.summary} />

      {/* System Information */}
      <h2 className="text-lg font-semibold pl-1 pt-4">System Information</h2>
      <div className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">

          <Card className="dark:bg-blue-400/5 px-6 py-5">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {systemInfo?.ContainersRunning || 0} running,{" "}
                    {systemInfo?.ContainersStopped || 0} stopped
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>Images:</span>
                  <span className="font-medium">{systemInfo?.Images || 0}</span>
                </div>
                <div className="flex justify-between">
                  <span>Memory:</span>
                  <span className="font-medium">
                    {systemInfo?.MemTotal ? `${(systemInfo.MemTotal / 1024 / 1024 / 1024).toFixed(1)} GB` : 'N/A'}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>CPU Cores:</span>
                  <span className="font-medium">{systemInfo?.NCPU || 0}</span>
                </div>
              </div>
            </CardBody>
          </Card>
            ...
            <CardBody className="p-0">
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{systemInfo?.Driver || 'N/A'}</span>
                </div>
                <div className="flex justify-between">
                  <span>OS:</span>
                  <span className="font-medium">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{systemInfo?.Architecture || 'N/A'}</span>
                </div>
              </div>
            </CardBody>
          </Card>
      ...
      <h2 className="text-lg font-semibold pl-1 pt-4">Last Scan</h2>
      {/* Last Scan */}
          ...
          <div className="flex flex-row items-start justify-between gap-3">
            <div className="flex gap-3 flex-1 min-w-0">
              <div className="min-w-0 flex-1">
                <p className="font-medium text-sm sm:text-base pb-2">
                  Last scan
                </p>
                <p className="text-xs sm:text-sm text-gray-500">
                  ...
                  {data.scan_status.scan_duration && (
                    <span className="block sm:inline sm:ml-2 mt-1 sm:mt-0">
                      Duration:{" "}
                      {(data.scan_status.scan_duration / 1000).toFixed(1)}s
                    </span>
                  )}
                </p>
              </div>
